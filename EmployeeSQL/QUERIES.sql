...
--Q5. List first name, last name, and sex of each employee whose first name is Hercules and whose 
...
--Q6. List each employee in the Sales department, including their employee number, last name, and 
--    first name.
...
ORDER BY departments.dept_name, emp_no;
